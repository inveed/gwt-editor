...
@UIPropertyAnnotation(implementor="net.inveed.gwt.server.propbuilders.ObjectRefPropertyBuilder")
public @interface UIObjectRefProperty {
	/**
	 * Property name.
	 * 
	 ...
	 * @return
	 */
	String defaultValueCode() default "";
	
	UISelectionFilter[] filters() default {};
	
	String notSetText() default "";
}
